...
export const ENTRY_SELECTOR = '[data-dsh-skills-manager-entry]'
...
export function mountSidebarEntry(onClick: () => void, locale?: LocaleRefreshSource): () => void {
  return mountSharedSidebarEntry({
    rowAttribute: 'data-dsh-skills-manager-entry',
    ...
    onToggle: onClick,
    position: 'after',
    familySelectors: ['[data-dsh-taskboard-entry]', '[data-dsh-ssh-entry]', '[data-dsh-skills-manager-entry]'],
  })
}
